    ...
    <div className="d-flex justify-content-center align-items-center min-vh-100" style={{ backgroundColor: '#ffc1cc' }}>
      <div className="card p-4" style={{ maxWidth: '400px', width: '100%' }}>
        <div className="card-body">
          ...
          <button className="btn btn-primary w-100 mb-3" onClick={fazerCadastro}>Cadastrar</button>
          <p className="text-center">
            Já tem conta? <Link to="/" className="text-decoration-none">Fazer login</Link>
          </p>
        </div>
      </div>
    </div>
